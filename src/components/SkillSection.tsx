...
const skillsData = [
    {
        ...
        icons: [
            "react", "nextdotjs", "typescript", "tailwindcss", "svelte", 
            "javascript", "html5", "css3", "vite", "webpack", "eslint", 
            "prettier", "figma", "vercel"
        ]
    },
    {
        ...
        icons: [
            "fastapi", "nodedotjs", "express", "go", "python", "postman", 
            "swagger", "jsonwebtokens", "redis", "nginx", "apache", "graphql"
        ]
    },
    {
        ...
        icons: [
            "pytorch", "python", "opencv", "openai", "tensorflow", "scikitlearn", 
            "jupyter", "anaconda", "numpy", "pandas", "matplotlib", "anthropic"
        ]
    },
    {
        ...
        icons: [
            "postgresql", "mongodb", "docker", "vercel", "git", "github", 
            "githubactions", "amazonaws", "googlecloud", "linux", "ubuntu", "railway"
        ]
    }
];
