...
const workEducationData = [
    ...
    },
    {
        ...
        <div>
            ...
            <div className="space-y-2">
                <p className="text-gray-300">
                • Built unified search API in <span className="text-green-400 font-medium">Go</span>, processing
                ...
                animations, debounced queries and error handling
                </p>
            </div>
            </div>
        </div>
    ...
    },
    {
        ...
        <div>
            ...
            <div className="space-y-2">
                <p className="text-gray-300">
                • <span className="text-blue-400 font-medium">Activities:</span> CS Tutoring, AggieWorks
                </p>
                <p className="text-gray-300">
                • <span className="text-blue-400 font-medium">Coursework:</span> Data Structures & Algorithms, Programming
